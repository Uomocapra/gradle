...
public interface JvmComponentDependencies extends PlatformDependencyModifiers, TestFixturesDependencyModifiers, GradleDependencies {
     ...
     *
     * @return a {@link DependencyCollector} that collects the set of compile-only dependencies
     * @since 7.6
     */
    DependencyCollector getCompileOnly();

    /**
     * Returns a {@link DependencyCollector} that collects the set of runtime-only dependencies.
     * <p>
     * <code>runtimeOnly</code> dependencies are not available at compilation and are used only at runtime.
     *
     * @return a {@link DependencyCollector} that collects the set of runtime-only dependencies
     * @since 7.6
     */
    DependencyCollector getRuntimeOnly();

    /**
     * Returns a {@link DependencyCollector} that collects the set of annotation processor dependencies.
     * <p>
     ...
     *
     * @return a {@link DependencyCollector} that collects the of annotation processor dependencies
     * @since 7.6
     */
